...
import { OVERNIGHT_MAXI_PADS_IMAGE_URL, ORGANIC_COTTON_TAMPONS_IMAGE_URL } from "./product-image";
...
const defaultProducts: Array<{
  ...
  { name: "Organic Cotton Tampons", description: "Chemical-free tampons made with organic cotton.", price: 229, category: "Tampons", imageUrl: ORGANIC_COTTON_TAMPONS_IMAGE_URL },
